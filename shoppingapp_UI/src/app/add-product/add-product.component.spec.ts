...
describe('AddProductComponent', () => {
  ...
  class MockUserRegistrationService extends ProductDetailsService {
    
    addNewProduct(addNewProductRequest: ProductDetails): Observable<ProductDetails> {
        addNewProductRequest.productQuantity = "10"
        return of(addNewProductRequest);
    }
  }
  ...
  it ("should call onAddNewProduct", () => {
    ...
    spyOn(productDetailsService, "addNewProduct").and.returnValue(of(newProductRequest));
    expect(component.onAddNewProduct).toBeDefined();
  });

  it ("should call onResetProductForm", () => {
    expect(component.onResetProductForm).toBeDefined();
  });
