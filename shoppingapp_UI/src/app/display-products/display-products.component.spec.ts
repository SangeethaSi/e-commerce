...
describe('DisplayProductsComponent', () => {
  ...
  let allProducts: Array<ProductDetails> = [{
    productId: 1,
    productName : "Shampoo", 
  ...
  },
  {
    ...
    features: "Makes the hair smooth",
    productStatus: "HURRY UP TO PURCHASE",
    productImageUrl: "https://5.imimg.com/data5/UE/XI/MY-6007704/hair-shampoo-500x500.jpg"
  }
  ...
  beforeEach(() => {
    ...
    spyOn(productDetailsService, "getAllProducts").and.returnValue(of(allProducts));
  ...
  it ("should call onProductSearch", () => {
    let productsRespOnSearch: Array<ProductDetails> = [{
      productId: 1,
      productName : "Shampoo", 
      productDescription: "No side effects",
      price: "$1",
    ...
    spyOn(productDetailsService, "getProductsByName").and.returnValue(of(productsRespOnSearch));
    expect(component.onProductSearch).toBeDefined();
  });

  it ("should call onResetSearch", () => {
    expect(component.onResetSearch).toBeDefined();
  });

  it ("should call onAddProductClick", () => {
    expect(component.onAddProductClick).toBeDefined();
  });

  it ("should call onProductUpdateClick", () => {
    expect(component.onProductUpdateClick).toBeDefined();
  });

  it ("should call onProductDeleteClick", () => {
    expect(component.onProductDeleteClick).toBeDefined();
  });
});
